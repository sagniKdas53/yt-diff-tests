...
function suiteName(testName: string): string {
  ...
  if (testName.startsWith("User ") || testName.startsWith("User")) return "Auth";
  return "Setup";
}
...
// SETUP: Auth
Deno.test("User Registration Check", tracked("User Registration Check", async () => {
...
Deno.test("User Registration", tracked("User Registration", async () => {
...
Deno.test("User Login", tracked("User Login", async () => {
...
Deno.test("TC-0.1 — Initial playlist list is empty", tracked("TC-0.1 — Initial playlist list is empty", async () => {
  const resp = await apiRequest("/getplay", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-0.2 — 'None' playlist sublist is empty", tracked("TC-0.2 — 'None' playlist sublist is empty", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-1.1 — Add 'Dup Test' playlist", tracked("TC-1.1 — Add 'Dup Test' playlist", async () => {
...
Deno.test("TC-1.2 — Playlist appears in listing", tracked("TC-1.2 — Playlist appears in listing", async () => {
  const resp = await apiRequest("/getplay", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-1.3 — Sublist contains the duplicate video at two positions", tracked("TC-1.3 — Sublist contains the duplicate video at two positions", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-1.4 — Download the video", tracked("TC-1.4 — Download the video", async () => {
...
Deno.test("TC-1.5 — Both duplicate positions now show as downloaded", tracked("TC-1.5 — Both duplicate positions now show as downloaded", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-1.6 — Update monitoring type to 'Full'", tracked("TC-1.6 — Update monitoring type to 'Full'", async () => {
  const resp = await apiRequest("/watch", {
    method: "POST",
    body: JSON.stringify({ url: PUBLIC_DUP_TEST_PLAYLIST_URL, watch: "Full" }),
  });
  const json = await resp.json();
  assertEquals(json.status, "success");
}));

Deno.test("TC-1.7 — Monitoring type change is reflected in playlist listing", tracked("TC-1.7 — Monitoring type change is reflected in playlist listing", async () => {
  const resp = await apiRequest("/getplay", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-2.1 — Add 'Dup Test 2' playlist", tracked("TC-2.1 — Add 'Dup Test 2' playlist", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-2.2 — Both playlists appear in listing", tracked("TC-2.2 — Both playlists appear in listing", async () => {
  const resp = await apiRequest("/getplay", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-2.3 — 'Dup Test 2' sublist shows the shared video as already downloaded", tracked("TC-2.3 — 'Dup Test 2' sublist shows the shared video as already downloaded", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-2.4 — Clean up files via /delsub", tracked("TC-2.4 — Clean up files via /delsub", async () => {
...
Deno.test("TC-2.5 — 'Dup Test 2' sublist shows video as un-downloaded", tracked("TC-2.5 — 'Dup Test 2' sublist shows video as un-downloaded", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-2.6 — 'Dup Test' sublist also reflects the shared un-downloaded state", tracked("TC-2.6 — 'Dup Test' sublist also reflects the shared un-downloaded state", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-2.7 — Unlink all videos from 'Dup Test 2', then delete playlist record", tracked("TC-2.7 — Unlink all videos from 'Dup Test 2', then delete playlist record", async () => {
...
Deno.test("TC-2.8 — Delete everything for 'Dup Test' (mappings + playlist + disk)", tracked("TC-2.8 — Delete everything for 'Dup Test' (mappings + playlist + disk)", async () => {
...
Deno.test("TC-3.1 — Add 'E7 Shorts', verify 2 videos are listed", tracked("TC-3.1 — Add 'E7 Shorts', verify 2 videos are listed", async () => {
...
Deno.test("TC-3.2 — Hard-delete first video (deleteVideosInDB = true)", tracked("TC-3.2 — Hard-delete first video (deleteVideosInDB = true)", async () => {
  const resp = await apiRequest("/delsub", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-3.3 — Sublist now contains only one video (at position 2)", tracked("TC-3.3 — Sublist now contains only one video (at position 2)", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-3.4 — Unlink second video (deleteVideoMappings = true, no DB delete)", tracked("TC-3.4 — Unlink second video (deleteVideoMappings = true, no DB delete)", async () => {
  const resp = await apiRequest("/delsub", {
    method: "POST",
    body: JSON.stringify({
      playListUrl: E7_SHORTS_PLAYLIST_URL,
...
Deno.test("TC-3.5 — Sublist is now empty; playlist record still exists", tracked("TC-3.5 — Sublist is now empty; playlist record still exists", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-3.6 — Delete only the playlist record", tracked("TC-3.6 — Delete only the playlist record", async () => {
  const resp = await apiRequest("/delplay", {
    method: "POST",
    body: JSON.stringify({
      playListUrl: E7_SHORTS_PLAYLIST_URL,
...
Deno.test("TC-4.1 — Add 'Screen recordings' and wait for full listing", tracked("TC-4.1 — Add 'Screen recordings' and wait for full listing", async () => {
  const listResp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-4.2 — Paginated sublist retrieval (3 pages, 17 total)", tracked("TC-4.2 — Paginated sublist retrieval (3 pages, 17 total)", async () => {
  // Page 1
...
Deno.test("TC-4.3 — Download a video within the playlist", tracked("TC-4.3 — Download a video within the playlist", async () => {
  const resp = await apiRequest("/download", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-4.4 — Add a video already in 'Screen recordings' to the 'None' playlist", tracked("TC-4.4 — Add a video already in 'Screen recordings' to the 'None' playlist", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-4.5 — 'None' sublist shows the newly added video", tracked("TC-4.5 — 'None' sublist shows the newly added video", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-4.6 — Download the video via the 'None' playlist context", tracked("TC-4.6 — Download the video via the 'None' playlist context", async () => {
  const resp = await apiRequest("/download", {
    method: "POST",
    body: JSON.stringify({ urlList: [BIG_VIDEO_15_URL], playListUrl: "None" }),
  });
  const json = await resp.json();
  assertEquals(json.status, "success");
  assertEquals(json.items[0].saveDirectory, "Screen recordings");
...
Deno.test("TC-4.7 — 'None' sublist confirms download success", tracked("TC-4.7 — 'None' sublist confirms download success", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
  ...
  assertEquals(json.rows[0].video_metadatum.isMetaDataSynced, true);
  assertEquals(json.rows[0].video_metadatum.saveDirectory, "Screen recordings");
}));

Deno.test("TC-4.8 — Download state visible from the original playlist context", tracked("TC-4.8 — Download state visible from the original playlist context", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 8,
...
Deno.test("TC-4.9 — sortDownloaded ordering (downloaded items first)", tracked("TC-4.9 — sortDownloaded ordering (downloaded items first)", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-8.1 — Batch-resolve signed URLs for multiple files", tracked("TC-8.1 — Batch-resolve signed URLs for multiple files", async () => {
...
Deno.test("TC-8.2 — Resolve a single signed URL", tracked("TC-8.2 — Resolve a single signed URL", async () => {
...
Deno.test("TC-8.3 — Stream file content using signed URL token", tracked("TC-8.3 — Stream file content using signed URL token", async () => {
...
Deno.test("TC-8.4 — Refresh a signed URL token before expiry", tracked("TC-8.4 — Refresh a signed URL token before expiry", async () => {
...
Deno.test("TC-5.1 — Delete the 'Screen recordings' playlist record", tracked("TC-5.1 — Delete the 'Screen recordings' playlist record", async () => {
  const resp = await apiRequest("/delplay", {
    method: "POST",
    body: JSON.stringify({
      playListUrl: PUBLIC_PLAYLIST_BIG_URL,
...
Deno.test("TC-5.2 — 'None' sublist immediately after deletion (before prune job runs)", tracked("TC-5.2 — 'None' sublist immediately after deletion (before prune job runs)", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-5.3 — 'None' sublist after prune job runs", tracked("TC-5.3 — 'None' sublist after prune job runs", async () => {
...
Deno.test("TC-6.1 — Re-add a video already downloaded in 'None' (no-op)", tracked("TC-6.1 — Re-add a video already downloaded in 'None' (no-op)", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
      urlList: [BIG_VIDEO_15_URL],
...
Deno.test("TC-6.2 — Add a new single video to 'None'", tracked("TC-6.2 — Add a new single video to 'None'", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-6.3 — Re-add the same un-downloaded video to 'None' (idempotent)", tracked("TC-6.3 — Re-add the same un-downloaded video to 'None' (idempotent)", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
      urlList: [SINGLE_VIDEO_URL],
...
Deno.test("TC-7.1 — Add 'Engineering Stuff' playlist and verify it has 1 video", tracked("TC-7.1 — Add 'Engineering Stuff' playlist and verify it has 1 video", async () => {
...
Deno.test("TC-7.2 — Unlink all videos from the playlist", tracked("TC-7.2 — Unlink all videos from the playlist", async () => {
  const resp = await apiRequest("/delplay", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-7.3 — Trigger re-index for all playlists in range", tracked("TC-7.3 — Trigger re-index for all playlists in range", async () => {
...
Deno.test("TC-7.4 — Sublist repopulated after re-index completes", tracked("TC-7.4 — Sublist repopulated after re-index completes", async () => {
  await waitForSubCount(ENGINEERING_PLAYLIST_URL, 1);
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("Setup Suite 10: Restore Dup Test with duplicates", tracked("Setup Suite 10: Restore Dup Test with duplicates", async () => {
  await (await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
      urlList: [PUBLIC_DUP_TEST_PLAYLIST_URL],
...
Deno.test("TC-10.1 — /getsub returns a mapping id for each row", tracked("TC-10.1 — /getsub returns a mapping id for each row", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-10.2 — Delete only the first duplicate by mapping ID", tracked("TC-10.2 — Delete only the first duplicate by mapping ID", async () => {
  const resp = await apiRequest("/delsub", {
    method: "POST",
    body: JSON.stringify({
      playListUrl: PUBLIC_DUP_TEST_PLAYLIST_URL,
...
Deno.test("TC-10.3 — Only one mapping remains (position 2 is intact)", tracked("TC-10.3 — Only one mapping remains (position 2 is intact)", async () => {
  const resp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-11.1 — Baseline: Delete Engineering Stuff and clear all", tracked("TC-11.1 — Baseline: Delete Engineering Stuff and clear all", async () => {
...
Deno.test("TC-11.2 — Trigger a failed playlist bootstrap", tracked("TC-11.2 — Trigger a failed playlist bootstrap", async () => {
  await (await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
...
Deno.test("TC-11.3 — Add a valid playlist immediately after the failure", tracked("TC-11.3 — Add a valid playlist immediately after the failure", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
      urlList: [ENGINEERING_PLAYLIST_URL],
...
Deno.test("TC-11.4 — Valid playlist gets sortOrder === 0 with no gap", tracked("TC-11.4 — Valid playlist gets sortOrder === 0 with no gap", async () => {
  const resp = await apiRequest("/getplay", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-11.5 — Teardown: delete the Engineering Stuff playlist", tracked("TC-11.5 — Teardown: delete the Engineering Stuff playlist", async () => {
  const resp = await apiRequest("/delplay", {
    method: "POST",
    body: JSON.stringify({
      playListUrl: ENGINEERING_PLAYLIST_URL,
...
Deno.test("TC-12.1 — Adding a known-but-unmapped video to 'None' uses fast-path insert", tracked("TC-12.1 — Adding a known-but-unmapped video to 'None' uses fast-path insert", async () => {
  await (await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
      urlList: [E7_SHORTS_PLAYLIST_URL],
...
Deno.test("TC-12.2 — Duplicate add to 'None' returns standardized message", tracked("TC-12.2 — Duplicate add to 'None' returns standardized message", async () => {
  const resp = await apiRequest("/list", {
    method: "POST",
    body: JSON.stringify({
      urlList: [E7_VIDEO_1_URL],
...
Deno.test("TC-12.3 — No filesystem paths in any 'None'-related response", tracked("TC-12.3 — No filesystem paths in any 'None'-related response", async () => {
  const subResp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
// Suite 9 — Cleanup
Deno.test("TC-9.1 — Remove remaining videos from 'None' playlist", tracked("TC-9.1 — Remove remaining videos from 'None' playlist", async () => {
  const subResp = await apiRequest("/getsub", {
    method: "POST",
    body: JSON.stringify({
      start: 0,
...
Deno.test("TC-9.2 — Delete any remaining playlists with full cleanup", tracked("TC-9.2 — Delete any remaining playlists with full cleanup", async () => {
